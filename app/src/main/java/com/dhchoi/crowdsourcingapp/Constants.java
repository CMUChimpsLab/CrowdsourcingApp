...
public class Constants {
    ...
    public static final String USER_REGISTERED_KEY = PACKAGE_NAME + ".USER_REGISTERED_KEY";
    ...
    public static final int RESULT_RECEIVER_SUCCESS = 0;
    public static final int RESULT_RECEIVER_FAIL = -1;
